 ...
 * Use the {@link DurationBaseReportFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DurationBaseReportFragment extends Fragment {
    TableLayout tb;
    ...
    Button report,clear;
    public DurationBaseReportFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_duration_base_report, container, false);
        date = view.findViewById(R.id.fromdate);
        date1 = view.findViewById(R.id.todate);
        report = view.findViewById(R.id.searchduration);
        clear = view.findViewById(R.id.clearduration);
        tb = view.findViewById(R.id.tableLayoutofdurationreport);
    ...
    private void fetchSupplierData() {
        Cursor cursor = db.rawQuery("SELECT prod_id, inv_id, cust_id, itm_name, itm_quantity, itm_total_price FROM invoice_item WHERE date_of_addition BETWEEN  '"+ date.getText() +"' AND '"+ date1.getText() +"'", null);
