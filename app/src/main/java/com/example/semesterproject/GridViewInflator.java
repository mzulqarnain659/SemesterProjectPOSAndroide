...
public class GridViewInflator extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertItem, ViewGroup parent) {
        ...
        ImageView productImage = gridView.findViewById(R.id.grid_imageview);
        TextView productName = gridView.findViewById(R.id.grid_textview);
